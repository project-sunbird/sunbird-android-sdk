...
public class TelemetryListener {
    ...
    @Subscribe
    public void onTelemetryEvent(TelemetryEvent telemetryEvent) throws InterruptedException {
        EventBusSubscriber.onTelemetryEvents(telemetryEvent, this.appContext);
    }
