...
public interface IParams {
    ...
    interface Key {
        ...
        String USER_SERVICE_BASE_URL_V2 = "USER_SERVICE_BASE_URL_V2";
        String DATA_SERVICE_BASE_URL = "DATA_SERVICE_BASE_URL";
        String ORG_SERVICE_BASE_URL = "ORG_SERVICE_BASE_URL";
        String COURSE_SERVICE_BASE_URL = "COURSE_SERVICE_BASE_URL";
        String FORM_SERVICE_BASE_URL = "FORM_SERVICE_BASE_URL";
        String DIALCODE_SERVICE_BASE_URL = "DIALCODE_SERVICE_BASE_URL";
        String PAGE_SERVICE_BASE_URL = "PAGE_SERVICE_BASE_URL";
        ...
        String OAUTH_SERVICE_IMPLEMENTATION = "OAUTH_SESSION";
        String ANNOUNCEMENT_BASE_URL = "ANNOUNCEMENT_BASE_URL";
        String DEVICE_REGISTER_BASE_URL = "DEVICE_REGISTER_BASE_URL";
        String WHITELIST_URL = "WHITELIST_URL";
    }
}
