...
public class GenieContentResolver {
    ...
    public GenieContentResolver(Context context, String authorityName, String contentId) {
    ...
    private Uri getUri() {
        String contentsUri = String.format("content://%s.content/", authorityName);
        return Uri.parse(contentsUri);
    }
