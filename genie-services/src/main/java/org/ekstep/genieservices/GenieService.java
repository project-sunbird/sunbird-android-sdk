...
public class GenieService {
    ...
    public static GenieService init(Context context, String packageName) {
        if (sService == null) {
            ...
            ContentPlayer.init(appContext.getParams().getString(ServiceConstants.Params.APP_QUALIFIER), (IPlayerConfig) appContext.getParams().get(ServiceConstants.Params.PLAYER_CONFIG));
