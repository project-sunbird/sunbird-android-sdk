 ...
 * @author anil
 */
public class EnrolCourseAPI extends SunbirdBaseAPI {

    private static final String TAG = EnrolCourseAPI.class.getSimpleName();

    private static final String ENDPOINT = "enrol";

    private Map<String, String> headers;
    private Map<String, Object> requestMap;

    public EnrolCourseAPI(AppContext appContext, Map<String, String> customHeaders, Map<String, Object> requestMap) {
        super(appContext,
